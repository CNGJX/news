$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '预览图', name: 'newsCoverImage', index: 'blogCoverImage', width: 120, formatter: coverImageFormatter},
            ...
            {label: '新闻分类', name: 'newsCategoryName', index: 'newsCategoryName', width: 60},
